    ...
    render() {
        ...
        return (
            <svg
                ...
                className={'player-body--vinyl-svg'}
            ...
            >
                ...
                <circle
                    ...
                    cy="159"
                    r="141"
                    className="vinyl-svg-circle-start"
                    style={{ display: this.props.playData.currentTime ? 'block' : 'none' }}
                />
                <circle
                    cx="148"
                    cy="159"
                    r="135"
                    className="vinyl-svg-circle-buffer"
                ...
                <circle
                    ...
                    cy="159"
                    r="135"
                    className="vinyl-svg-circle-currentTime"
                ...
                <circle
                    ...
                    cy="159"
                    r="135"
                    className="vinyl-svg-circle-currentTime-indicator"
                    stroke="url(#gradientCurrentTime)"
                    id={'circleIndicator'}
                    style={{ display: this.props.playData.currentTime ? 'block' : 'none' }}
                />
